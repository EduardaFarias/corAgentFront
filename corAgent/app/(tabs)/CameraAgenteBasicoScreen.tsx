    ...
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      >
        ...
        <View style={styles.iconBadge}>
          <Eye size={40} color="#33283e" />
        </View>

        {/* Title & Description */}
        <Text style={styles.title}>Agente Básico</Text>
        <Text style={styles.description}>
          Toque em qualquer ponto da tela para identificar a cor
        </Text>

        {/* Main Illustration Card */}
        <View style={styles.card}>
          <Image
           source={require("../../assets/images/color-art.png")}
...
export default CameraAgenteBasicoScreen;